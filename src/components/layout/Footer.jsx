...
const Footer = () => (
    <footer className="mt-5 ">
        ...
        <div className="social-footer-wrapper">
            {/* Instagram */}
            <a href="https://www.instagram.com/bandadeguerra_lvl/" className="social-footer-container instagram">
                <svg className="social-footer-svg" viewBox="0 0 16 16">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@bandadeguerra_lvl" className="social-footer-container tiktok">
                <svg className="social-footer-svg" viewBox="0 0 16 16">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/LiceoValentinLetelierMadariaga" className="social-footer-container facebook">
                <svg className="social-footer-svg" viewBox="0 0 16 16">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@bdg_lvl" className="social-footer-container youtube">
                <svg className="social-footer-svg" viewBox="0 0 16 16">
            ...
            {/* Email (Envelop) */}
            <a href="#" className="social-footer-container email">
                <svg className="social-footer-svg" viewBox="0 0 16 16">
